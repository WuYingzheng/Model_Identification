...
from simulate import get_simulated_receptance
from fft_tools import irfft_adjusted_lower_limit
from misc import toeplitz, prime_factors, complex_freq_to_freq_and_damp
...
def lscf(frf, low_lim, n, dt, weighing_type='Unity', reconstruction='LSFD'):
    ...
    :param frf:            频响函数, frequency response function - receptance
    :param low_lim:        频响函数的下限, lower limit of the frf
    :param n:              多项式的阶数, the order of the polynomial
    :param dt:             采样时间间隔, time sampling interval
    :param weighing_type:  weighing type (TO BE UPDATED)
    :param reconstruction: type of reconstruction - LSFD or LSCF
    :return:               本征频率和对应的阻尼, eigenfrequencies and the corresponding damping
    """
