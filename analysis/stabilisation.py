...
from misc import complex_freq_to_freq_and_damp, prime_factors
from lscf import lscf
...
def stabilisation(sr, nmax, err_fn, err_xi):
    ...
    :param err_fn: 频率相对误差, relative error in frequency
    :param err_xi: 阻尼相对误差, relative error in damping
